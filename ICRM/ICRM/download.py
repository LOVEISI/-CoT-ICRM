...
def download_femnist(data_dir):
    # 原始 URL: https://github.com/IBM/FEMNIST
    full_path = stage_path(data_dir, "FEMNIST")
    
    # FEMNIST 数据集下载链接
    femnist_url = "https://drive.google.com/uc?id=1I9YxUpnM6Ln2mYzxUBj68Q--pGxKcqgA"
    
    # 使用 gdown 下载数据
    download_and_extract(femnist_url, os.path.join(data_dir, "femnist.tar.gz"))
